...
@skip_if_no_cl
def test_complex_nearest_against_numpy_2d():
    # Create random 100x120 image
    X = np.zeros((100,120), dtype=np.complex64)
    X.real = np.random.rand(100,120)
    X.imag = np.random.rand(100,120)
...
@skip_if_no_cl
def test_complex_nearest_against_numpy_3d():
    # Create random 100x120x4 image
    X = np.zeros((100,120,4), dtype=np.complex64)
    X.real = np.random.rand(100,120,4)
    X.imag = np.random.rand(100,120,4)
